...
# -- configs ----------------------------------------------------------
abbr --add a "nano ~/.config/fish/conf.d/abbr.fish"
abbr --add e "nano ~/.config/fish/conf.d/env.fish"
abbr --add cfg "nano ~/.config/fish/config.fish"
abbr --add cu "nano ~/.config/fish/conf.d/custom.fish"
abbr --add gc "nano ~/.config/git/config"
abbr --add init-brew "nano ~/.init/mac/scripts/brew.sh"
abbr --add init-casks "nano ~/.init/mac/scripts/casks.sh"
abbr --add init-pkgs "nano ~/.init/linux/scripts/apt_packages.sh"
abbr --add lo "nano ~/.config/fish/conf.d/local.fish"
abbr --add tc "nano ~/.tmux.conf"
